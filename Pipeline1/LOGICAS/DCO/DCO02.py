...
aceptar_art = " Se presiona el boton 'Aceptar', para ingresar el articulo y la cantidad."
doc_emitidos = " Se encontró y abrió el documento emitido "


# ----------------------------- Funciones Unicas para DCO02--------------------------------------
def ingreso(self):
    try:
        ingreso_chrome()
...
def validar_articulos(self):
    ...
    try:
        ...
        articulo1.send_keys(Configuracion.codigo_art22_vco)
        Log().info(f" Ingresa el código del articulo {Configuracion.codigo_art22_vco}")
        time.sleep(1)

        refresca1 = wait.until(EC.presence_of_element_located((By.XPATH, Configuracion.btn_refresca)))
        refresca1.click()
        Log().info(" Se presiona el boton 'Refrescar', para mostrar la informacion del articulo 1")
        time.sleep(2)

        art1 = driver.find_element(By.XPATH, Configuracion.articulo22)
        action \
            .double_click(art1) \
            .pause(0) \
            .release()
        ...
        cerrararticulo1 = wait.until(EC.presence_of_element_located((By.XPATH, Configuracion.btn_cerrar_ventana1)))
        cerrararticulo1.click()
        time.sleep(2)
        ...
        articulo2.click()
        articulo2.send_keys(Configuracion.codigo_art4_vco)
        Log().info(f" Ingresa el codigo del articulo {Configuracion.codigo_art4_vco}")
        time.sleep(1)

        refresca2 = wait.until(EC.presence_of_element_located((By.XPATH, Configuracion.btn_refresca)))
        refresca2.click()
        Log().info(" Se presiona el boton 'Refrescar', para mostrar la informacion del artículo 2")
        time.sleep(2)
        ...
        cerrararticulo2 = wait.until(EC.presence_of_element_located((By.XPATH, Configuracion.btn_cerrar_ventana1)))
        cerrararticulo2.click()
        time.sleep(2)
        ...
        articulo3.click()
        articulo3.send_keys(Configuracion.codigo_art6_vco)
        ...
        refresca3.click()
        Log().info(" Se presiona el boton 'Refrescar', para mostrar la informacion del articulo 3.")
        time.sleep(2)

        art3 = driver.find_element(By.XPATH, Configuracion.articulo6)
        action \
            .double_click(art3) \
            .pause(0) \
            .release()
        ...
        cerrararticulo3 = wait.until(EC.presence_of_element_located((By.XPATH, Configuracion.btn_cerrar_ventana1)))
        cerrararticulo3.click()
        time.sleep(2)
...
def validacion_dz2():
    ...
    try:
        ...
        # Filtra por codigo de articulo
        stock = df_stock[(df_stock['Codigo'] == Configuracion.codigo_art22_vco)
                         | (df_stock['Codigo'] == Configuracion.codigo_art4_vco)
                         | (df_stock['Codigo'] == Configuracion.codigo_art6_vco)]
...
def validacion_dz3():
    try:
        ...
        Log().error(f"No se pudo actualizar el reporte DZ 3 {e}")
        raise
    try:
        # El elemento deseado está dentro de un <iframe> por lo que hay que:
        # Inducir al WebDriverWait para que el frame deseado esté disponible y cambiar a él.
        ...
        stock_ttable_df = pd.read_html(StringIO(tabla_reporte_1))[0]
        ...
        # Filtra por codigo de articulo
        stock_final = df_stock[(df_stock['Codigo'] == Configuracion.codigo_art22_vco)
                               | (df_stock['Codigo'] == Configuracion.codigo_art4_vco)
                               | (df_stock['Codigo'] == Configuracion.codigo_art6_vco)]
...
def datos_vco(self):
    try:
        ...
        Log().error(f"No se pudo ingresar y abrir la venta de contado {e}")
        raise
    try:
        ...
        time.sleep(1)
        Log().info(f"Se agregar al cliente: {Configuracion.cuenta} para realizar la venta de contado por unidad")
        ...
        observaciones2.send_keys(Configuracion.i_observaciones_vco2)
        time.sleep(1)
        ...
        articulo.click()
        time.sleep(1)
        articulo.send_keys(Configuracion.codigo_art22_vco)
    ...
    try:
        ...
        Log().info(
            f" Ingresa la cantidad de: {Configuracion.cantidad_art1} del articulo: {Configuracion.codigo_art22_vco}")
        time.sleep(1)
        ...
        articulo_1.click()
        time.sleep(1)
        articulo_1.send_keys(Configuracion.codigo_art4_vco)
        time.sleep(1)

        ccantidad_1 = wait.until(EC.presence_of_element_located((By.XPATH, Configuracion.campo_cantidad)))
        wait.until(EC.visibility_of(ccantidad_1))
        ccantidad_1.click()
        time.sleep(1)
        ccantidad_1.send_keys(Configuracion.cantidad_art1)
        Log().info(
            f" Ingresa la cantidad de: {Configuracion.cantidad_art1} del articulo: {Configuracion.codigo_art4_vco}")
        ...
        wait.until(EC.visibility_of(articulo_2))
        articulo_2.click()
        time.sleep(1)
        articulo_2.send_keys(Configuracion.codigo_art6_vco)
        time.sleep(1)

        ccantidad_2 = wait.until(EC.presence_of_element_located((By.XPATH, Configuracion.campo_cantidad)))
        wait.until(EC.visibility_of(ccantidad_2))
        ccantidad_2.click()
        time.sleep(1)
        ccantidad_2.send_keys(Configuracion.cantidad_art1)
        time.sleep(1)
        Log().info(
            f" Ingresa la cantidad de: {Configuracion.cantidad_art1} del articulo: {Configuracion.codigo_art6_vco}")

        aceptar_2 = wait.until(EC.presence_of_element_located((By.XPATH, Configuracion.btn_aceptar)))
        wait.until(EC.visibility_of(aceptar_2))
        time.sleep(1)
        aceptar_2.click()
        Log().info(aceptar_art)
        time.sleep(1)
        ...
        Log().error(f"No se pudieron ingresar los datos del cliente en la venta de contado {e}")
        raise
...
def datos_dco(self):
    try:
        ...
        Log().error(f"No se pudo ingresar al documento devolución de contado {e}")
        raise
    try:
        cliente = wait.until(EC.presence_of_element_located((By.XPATH, Configuracion.campo_cliente)))
        cliente.send_keys(Configuracion.cuenta)
        time.sleep(1)
        Log().info(f"Se agregar al cliente: {Configuracion.cuenta} para realizar la venta de contado por packing")
        ...
        observaciones1_2 = wait.until(EC.presence_of_element_located((By.XPATH, Configuracion.campo_obs2)))
        observaciones1_2.send_keys(Configuracion.i_observaciones_dco2)
        time.sleep(1)

        agrega_item = wait.until(EC.presence_of_element_located((By.XPATH, Configuracion.btn_agrega_item)))
        agrega_item.click()
        agrega_item.click()
        time.sleep(0)

        # ingreso del primer articulo
        articulo1_1 = wait.until(EC.visibility_of_element_located((By.XPATH, Configuracion.campo_articulo)))
        wait.until(EC.visibility_of(articulo1_1))
        articulo1_1.click()
        time.sleep(1)
        articulo1_1.send_keys(Configuracion.codigo_art22_vco)
        time.sleep(1)
    ...
    try:
        ...
        articulo_2.click()
        time.sleep(1)
        articulo_2.send_keys(Configuracion.codigo_art4_vco)
        time.sleep(1)
        ...
        # ------------------------------------- Ingreso articulo 3 -----------------------------------------
        articulo_3 = wait.until(EC.presence_of_element_located((By.XPATH, Configuracion.campo_articulo)))
        wait.until(EC.visibility_of(articulo_3))
        articulo_3.click()
        time.sleep(1)
        articulo_3.send_keys(Configuracion.codigo_art6_vco)
        time.sleep(1)

        ccantidad_3 = wait.until(EC.presence_of_element_located((By.XPATH, Configuracion.campo_cantidad)))
        wait.until(EC.visibility_of(ccantidad_3))
        ccantidad_3.click()
        time.sleep(1)
        ccantidad_3.send_keys(Configuracion.cantidad_art1)
        time.sleep(1)
        Log().info(
            f" Ingresa la cantidad de: {Configuracion.cantidad_art1} del articulo: {Configuracion.codigo_art6_vco}")
        time.sleep(1)

        aceptar_3 = wait.until(EC.presence_of_element_located((By.XPATH, Configuracion.btn_aceptar)))
        wait.until(EC.visibility_of(aceptar_3))
        time.sleep(1)
        aceptar_3.click()
        Log().info(aceptar_art)
        time.sleep(1)
...
def impuesto_venta(self):
    try:
        ...
        validaiva = wait.until(EC.presence_of_element_located((By.XPATH, Configuracion.iva_devolucion_contado2))).text
        self.assertEqual("232.74", validaiva, "El IVA es correcto")
        Log().info("El IVA de la venta es correcto")
        time.sleep(1)

        validatotal = wait.until(EC.presence_of_element_located((
            By.XPATH, Configuracion.total_devolucion_contado2))).text
        self.assertEqual("1,687.34", validatotal, "El total es correcto")
        ...
        Log().error(f"No se pudo leer correctamente el detalle del cálculo del documento {e}")
        raise
...
def documento_emitido(self):
    try:
        ...
        Log().error(f"No se pudo abrir el menú de documentos emitidos {e}")
        raise
    try:
    ...
    try:
        ...
        Log().error(f"No se pudo dirigir hacia abajo al documento emitido {e}")
        raise
    ...
    try:
        ...
        cierra_todo.click()
        Log().info(" Se presiona el boton 'Cerrar', para cerrar pantalla de documentos.")
        time.sleep(2)
    except Exception as e:  # pragma: no cover
        Log().error(f"No se pudo abrir el documento emitido {e}")
        raise
...
def documento_emitido2(self):
    try:
        ...
        Log().error(f"No se pudo ingresar al menú de documentos emitidos {e}")
        raise
    try:
        ...
        Log().error(f"No se pudo buscar el documento emitido {e}")
        raise
    ...
    try:
        ...
        Log().error(f"No se pudo extraer la serie y el número de documento de la venta {e}")
        raise
    ...
    try:
        ...
        Log().error(f"No se pudo deslizar hacia abajo el documento emitido {e}")
        raise
    ...
    try:
        ...
        cierra_todo_1 = wait.until(EC.presence_of_element_located((By.XPATH,
                                                                   f"({Configuracion.btn_cerrar_pantalla})[1]")))
        cierra_todo_1.click()
        Log().info(" Se presiona el boton 'Cerrar', para cerrar pantalla de documentos")
        time.sleep(2)
    except Exception as e:  # pragma: no cover
        Log().error(f"No se pudieron cerrar las ventanas correctamente {e}")
        raise
...
def num_doc(self):
    ...
    try:
        ...
        Log().error(f"No se pudo visualizar el reporte {e}")
        raise
    try:
        funciones.col_devolucion(self)
    except Exception as e:  # pragma: no cover
        Log().error(f"No se pudo ordenar la columna devoluciones {e}")
        raise


# ---------------------------------- Inicio de la automatización DCO02---------------------------------------------
