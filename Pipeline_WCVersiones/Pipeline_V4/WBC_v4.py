...
buscar_v4 = " Se busca la versión 4 en el sistema"
buscar_v4_base = " Se busca la versión 4 con pex en el sistema"
buscar_version = r'\b\d+\.\d+\.\d+\.\d+\b'
buscarversion4 = r'\b4\.0\.0\.\d+\b'
...
ingreso_pex = " Ingresa al código pex."
...
class WBC28:  # clase del código
    ...
    try:
        ...
        buscar_usuario_wbc2_1.send_keys(Configuracion.buscar_v4)  # -> Configuración assist
    ...
    try:
        buscar_usuario_wbc2_1 = wait.until(EC.presence_of_element_located((By.XPATH, Configuracion.campo_buscar)))
        buscar_usuario_wbc2_1.send_keys(Configuracion.grupo_v4)  # -> Configuración assist
        buscar_usuario_wbc2_1.send_keys(Keys.ENTER)
        Log().info(buscar_v4_base)
        time.sleep(1)
    ...
    try:
        codigo_pex_1 = driver.find_element(By.XPATH, Configuracion.pex)
        action \
            .move_to_element(codigo_pex_1) \
            .pause(1) \
            .double_click(codigo_pex_1) \
            .pause(1) \
            .release()
        action.perform()
        Log().info(ingreso_pex)
        time.sleep(1)
    except Exception as e:  # pragma: no cover
    ...
    try:
        ...
        for elem in version_actual1_1:
            ...
            match = re.search(buscarversion4, texto)
            if match:
                ...
                try:
                    ...
                    element_1 = driver.find_element(By.XPATH, Configuracion.ultima_v4)
                    element_1.click()
                    Log().info(f" Nueva versión creada: {nueva_version}")
    ...
    try:
        ...
        if "403" in contenido_pagina_1 or "Forbidden" in contenido_pagina_1:
            ...
            try:
                ...
                buscar_usuario_wbc2_2.send_keys(Configuracion.buscar_v4)  # -> Configuración assist
            ...
            try:
                buscar_usuario_wbc2_2 = wait.until(EC.presence_of_element_located((
                    By.XPATH, Configuracion.campo_buscar)))
                buscar_usuario_wbc2_2.send_keys(Configuracion.grupo_v4)  # -> Configuración assist
                buscar_usuario_wbc2_2.send_keys(Keys.ENTER)
                Log().info(buscar_v4_base)
                time.sleep(1)
            ...
            try:
                codigo_pex_2 = driver.find_element(By.XPATH, Configuracion.pex)
                action \
                    .move_to_element(codigo_pex_2) \
                    .pause(1) \
                    .double_click(codigo_pex_2) \
                    .pause(1) \
                    .release()
                action.perform()
                Log().info(ingreso_pex)
            ...
            try:
                ...
                for elem in version_actual_2:
                    texto_2 = elem.text.strip()
                    match_2 = re.search(buscarversion4, texto_2)
                    if match_2:
                        Log().info(f" Versión actual: {version}")
                        todas_las_versiones_2.append(version)  # Aseguramos que sean strings
                        ...
                        try:
                            ultima_version = max(todas_las_versiones_2, key=lambda v: [int(x) for x in v.split(".")])
                            element_2 = driver.find_element(By.XPATH, Configuracion.ultima_v4)
                            element_2.click()
                            Log().info(f" Nueva versión creada: {nueva_version}")
            ...
            try:
                ...
                if "403" in contenido_pagina_2 or "Forbidden" in contenido_pagina_2:
                    ...
                    try:
                        ...
                        buscar_usuario_wbc2_3.send_keys(Configuracion.buscar_v4)  # -> Configuración assist
                    ...
                    try:
                        ...
                        for elem in versiones_3:
                            ...
                            if ultima_version:
                                ...
                                campo_id_powerstreet_3 = driver.find_element(By.XPATH,
                    ...
                    try:
                        buscar_usuario_wbc2_3 = wait.until(
                            EC.presence_of_element_located((By.XPATH, Configuracion.campo_buscar)))
                        buscar_usuario_wbc2_3.send_keys(Configuracion.grupo_v4)  # -> Configuración assist
                        buscar_usuario_wbc2_3.send_keys(Keys.ENTER)
                        Log().info(buscar_v4_base)
                        time.sleep(1)
                    ...
                    try:
                        codigo_pex_3 = driver.find_element(By.XPATH, Configuracion.pex)
                        action \
                            .move_to_element(codigo_pex_3) \
                            .pause(1) \
                            .double_click(codigo_pex_3) \
                            .pause(1) \
                            .release()
                        action.perform()
                        Log().info(ingreso_pex)
                        ...
                        for elem in version_actual_3:
                            ...
                            if match:
                                ...
                                try:
                                    ...
                                    element_3 = driver.find_element(By.XPATH, Configuracion.ultima_v4)
                                    element_3.click()
                                    Log().info(f" Nueva versión creada: {nueva_version}")
